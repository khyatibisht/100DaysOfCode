...
- Today's June LeetCoding challenge 
- HackerRank's #30DaysOfCode problem
- Completed FCC lessons for Responsive Web Design Certification 🤩. Will start the JS Algorithms and Data Structures course right away as I continue to complete the remaining projects side by side.
- Next: FCC Technical Documentation (content is ready, now designing is left)
- Side note: Gonna try to improve my sleeping schedule in order to make maximum use of the day! 

#### DAY 27: JUNE 27, 2020
- Today's June LeetCoding challenge 
- HackerRank's #30DaysOfCode problem
- FCC: Technical Documentation = I have completed navbar coding and footer. Prepared the trello board for it. 

#### DAY 28: JUNE 28, 2020
- June LeetCoding Challenge
- HackerRank #30DaysOfCode problem
- Read tech articles on medium. <br/>
As I felt demotivated today to do something creative/new, I realised the importance of habits- Coding 1 challenge daily come easily even as I struggle to think/design/plan for a new project. This is where #100DaysOfCode has helped, making sure I do something little everyday! Looking forward to a more productive tomorrow!

#### DAY 29: JUNE 29, 2020
- June LeetCoding Challenge
- HackerRank #30DaysOfCode problem
- Technical Documentation project: I finally corrected the scroll issue and changed the color scheme. I am updating the content and will finally end it tomorrow.


#### DAY 30: JUNE 30, 2020
- June LeetCoding Challenge Completed
- HackerRank #30DaysOfCode Completed
- FCC: Technical Documentation Completed
- Successfully made notes for all the important learnings from the first two challenges.
